    ...
    <div class="card">
        ...
        <div class="card-body card-block">
            ...
            <div class="form-group">
                <label  for="name" 
                        class="form-control-label">Nama Barang
                </label>
            ...
            <div class="form-group">
                <label  for="photo" 
                        class="form-control-label">Foto Barang
                </label>
                <input  type="file" 
                        name="photo" 
                        value="{{ old('photo') }}" 
            ...
            <div class="form-group">
                <label  for="is_default" 
                        class="form-control-label">Jadikan default
                </label>
                <br>
                <label>
                    <input  type="radio" 
            ...
            <button class="btn btn-primary btn-block">Tambah Foto Barang</button>
            </form>
        </div>
    </div>
@endsection